<%-- 
    Document   : cart
    Created on : Feb 23, 2020, 1:42:22 PM
    Author     : trang
--%>

<%@page import="trangbtt.dtos.CartDTO"%>
                            ...
                            <tbody>
                                <c:forEach var="dto" items="${shop.cart.values()}" varStatus="counter">
                                    <tr>
                                        ...
                                        <td style="padding: 20px 20px;">
                                            <form action="DeleteCartController" method="POST" onSubmit="return confirm('Do you want to submit?')">
