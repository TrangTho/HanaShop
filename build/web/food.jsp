<%-- 
    Document   : food
    Created on : Feb 11, 2020, 1:05:52 PM
    Author     : trang
--%>

<%@page import="trangbtt.dtos.CategoryDTO"%>
<%@page import="java.util.List"%>
<%@page import="trangbtt.daos.CategoryDAO"%>
    ...
    <body>
        ...
        <div>
            <form action="SearchByPriceController" method="POST" style="display: flex; justify-content: center;">
                ...
                <p class="nameSelect">From:</p> <input style="height: 30px;" type="text" name="txtFrom" value="${param.txtFrom}"/>
                <p class="nameSelect">To</p> <input style="height: 30px;" type="text" name="txtTo" value="${param.txtTo}"  />
            ...
            <form action="SearchByCateController" method="POST" style="display: flex; justify-content: center; width: 50%; margin-left: 25%;">
                ...
                <select class="create" name="slCategory" style="width: 60%;">
