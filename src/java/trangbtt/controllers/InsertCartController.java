...
//                for (CartDTO dtoC : shoppingCart.getCart().values()) {
//                    if (dtoC.getQuantity() < dtoC.getQuantityCart()) {
//                        url = ERROR;
//                        request.setAttribute("ERROR", "The product is out of stock. Please return to Cart!");
//                        return;
//                    }
//                }
