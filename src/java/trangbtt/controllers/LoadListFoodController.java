...
import trangbtt.daos.CategoryDAO;
import trangbtt.daos.FoodDAO;
import trangbtt.dtos.CategoryDTO;
import trangbtt.dtos.FoodDTO;
import trangbtt.dtos.FoodPaging;

/**
 *
 * @author trang
 */
public class LoadListFoodController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<FoodDTO> result = dao.loadListSearch(icurrentPage, 20);
            loadPage.setListFood(result);
            int count = dao.countRowActive();
