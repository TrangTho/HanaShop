 ...
 * @author trang
 */
public class SearchHistoryByNameController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String nameF = request.getParameter("txtName");
            if (!nameF.equals("")) {
                CartDAO dao = new CartDAO();
                List<CartDTO> result = dao.searchHistoryByName(user, nameF);
                if(result != null){
